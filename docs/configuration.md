...
Only when main's own model is genuinely unknown does an unpinned build fall back to passing no override at all, which is the behavior from before this file existed.
