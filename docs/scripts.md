...
| `fm-lock-owner-lib.sh` | Shared validation and comparison for numeric and sandbox Codex session-lock owner tokens |
| `fm-session-lock-lib.sh` | Shared session-lock harness ancestry, holder liveness, and current-owner checks for lock consumers |
