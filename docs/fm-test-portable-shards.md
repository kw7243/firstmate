...
| portable serial 1-5 | job `timeout-minutes: 30` | Each balanced shard carries about 13.69 minutes of conservative assignment weight, while the larger bound preserves hang-tripwire headroom when expanded tests temporarily outgrow their duration hints. |
