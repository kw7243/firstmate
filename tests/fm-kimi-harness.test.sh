...
test_kimi_launch_then_send_is_verified() {
  ...
  [ "$launch" = "env -u CODEX_THREAD_ID -u CURSOR_AGENT -u CURSOR_INVOKED_AS '$FAKEBIN_DIR/kimi' --model 'kimi-code/k3' --auto" ] \
...
test_kimi_falls_back_to_expanded_home_binary() {
  ...
  launch=$(cat "$CASE_DIR/launch.log")
  [ "$launch" = "env -u CODEX_THREAD_ID -u CURSOR_AGENT -u CURSOR_INVOKED_AS '$fallback' --auto" ] \
