...
- `research-notebook-reminder` - load before routing, briefing, starting, or placing artifacts for research, experiments, scaffolds, reports, or other non-Firstmate project work.
