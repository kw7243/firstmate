...
detect_own() {
  ...
  # Claude, Codex sandboxed tool calls, Pi, and Grok set verified markers of
  # their own; opencode and kimi are markerless, so a foreign marker retained in
  # a terminal multiplexer's stored environment can silently misidentify one of
